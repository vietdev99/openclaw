import { At as randomToken, Dt as openUrl, Et as normalizeGatewayTokenInput, K as readRestartSentinel, Ln as getMemorySearchManager, Lt as normalizeControlUiBasePath, Nt as summarizeExistingConfig, Ot as printWizardHeader, Pt as waitForGatewayReachable, St as formatControlUiSshHint, Tr as peekSystemEvents, _t as DEFAULT_WORKSPACE, bt as detectBrowserOpenSupport, d as sha256HexPrefix, dt as formatUsageReportLines, jt as resolveControlUiLinks, kt as probeGatewayReachable, m as listAgentsForGateway, q as summarizeRestartSentinel, ut as loadProviderUsageSummary, vr as lookupContextTokens, vt as applyWizardMetadata, wt as handleReset, xt as ensureWorkspaceAndSessions, zt as getRemoteSkillEligibility } from "./reply-CB1HncR0.js";
...
import { c as resolveDefaultAgentId, h as DEFAULT_IDENTITY_FILENAME, p as DEFAULT_BOOTSTRAP_FILENAME, r as resolveAgentDir, s as resolveAgentWorkspaceDir } from "./agent-scope-DQsZcpdg.js";
import { Ct as DEFAULT_MODEL, St as DEFAULT_CONTEXT_TOKENS, d as resolveConfiguredModelRef, pt as ensureAuthProfileStore, wt as DEFAULT_PROVIDER } from "./model-selection-DQgw6aTr.js";
import { r as resolveCliName, t as formatCliCommand } from "./command-format-DELazozB.js";
import { c as writeConfigFile, i as loadConfig, j as VERSION, o as readConfigFileSnapshot } from "./config-CtmQr4tj.js";
import { n as listChannelPlugins } from "./plugins-BBMxV8Ev.js";
import { L as resolveMainSessionKey, d as loadSessionStore } from "./sandbox-BeLcMLgY.js";
import { d as inspectPortUsage, f as resolveLsofCommandSync, p as formatPortDiagnostics } from "./chrome-C-btz7RP.js";
import { o as resolveStorePath } from "./paths-QIdkbvwm.js";
import { t as buildChannelSummary } from "./channel-summary-DQfUtO8j.js";
...
import { a as findTailscaleBinary, o as getTailnetHostname, s as readTailscaleStatusJson } from "./tailscale-Dmbkh3Jx.js";
import { a as gatewayInstallErrorHint, i as buildGatewayInstallPlan, n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-wpwJ6TMm.js";
...
import { c as promptDefaultModel, d as warnIfModelConfigLooksOff, f as applyAuthChoice, g as promptAuthChoiceGrouped, r as promptRemoteGatewayConfig, s as applyPrimaryModel, t as setupSkills, u as resolvePreferredProviderForAuthChoice } from "./onboard-skills-B8XIu18e.js";
import { n as setupChannels } from "./onboard-channels-Dey_diQI.js";
import { l as healthCommand, n as ensureControlUiAssetsBuilt, s as formatHealthChannelLines, t as formatHealthCheckFailure, u as resolveHeartbeatSummaryForAgent } from "./health-format-DJrrrP5C.js";
import { C as resolveEffectiveUpdateChannel, S as normalizeUpdateChannel, d as formatUpdateOneLiner, f as getUpdateCheckResult, h as compareSemverStrings, l as ensureCompletionCacheExists, m as checkUpdateStatus, p as resolveUpdateAvailability, s as checkShellCompletionStatus, u as formatUpdateAvailableHint, x as formatUpdateChannelLabel } from "./update-runner-CkODAlIi.js";
import { i as probeGateway, t as runSecurityAudit } from "./audit-BbwcHQGY.js";
import { t as renderTable } from "./table-CUojT09_.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-C3tW33Fh.js";
import { o as resolveGatewayLogPaths, t as resolveGatewayService } from "./service-DCJ10BWe.js";
import { r as isSystemdUserServiceAvailable } from "./systemd-B4GAf9ji.js";
import { o as readLastGatewayErrorLine } from "./service-audit-Da6maOeP.js";
...
import { i as redactSecrets, n as formatDuration$1, r as formatGatewayAuthUsed, t as formatAge$1 } from "./format-6z36TR-f.js";
import { r as installCompletion } from "./completion-cli-D5WMLiYK.js";
import { t as buildWorkspaceHookStatus } from "./hooks-status-CBwtt470.js";
...
async function finalizeOnboardingWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-DwEL6biB.js").then((n) => n.r);
