...
import { P as resolveConfiguredModelRef, bt as DEFAULT_MODEL, v as ensureAuthProfileStore, xt as DEFAULT_PROVIDER, yt as DEFAULT_CONTEXT_TOKENS } from "./auth-profiles-YXdFjQHW.js";
...
import { c as writeConfigFile, i as loadConfig, j as VERSION, o as readConfigFileSnapshot } from "./config-DUG8LdaP.js";
...
import { I as resolveMainSessionKey, d as loadSessionStore } from "./sandbox-DmkfoXBJ.js";
import { t as buildChannelSummary } from "./channel-summary-DVXSGmKv.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-DJU0m2T0.js";
import { r as installCompletion } from "./completion-cli-jLLbxupJ.js";
import { a as gatewayInstallErrorHint, i as buildGatewayInstallPlan, n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-DlCmxGC0.js";
...
import { o as readLastGatewayErrorLine } from "./service-audit-DgvQl2q7.js";
import { t as renderTable } from "./table-CL2vQCqc.js";
import { i as probeGateway, t as runSecurityAudit } from "./audit-DFt8PvHu.js";
import { d as applyAuthChoice, h as promptAuthChoiceGrouped, l as resolvePreferredProviderForAuthChoice, o as applyPrimaryModel, r as promptRemoteGatewayConfig, s as promptDefaultModel, t as setupSkills, u as warnIfModelConfigLooksOff } from "./onboard-skills-d8c_JMyu.js";
import { l as healthCommand, n as ensureControlUiAssetsBuilt, s as formatHealthChannelLines, t as formatHealthCheckFailure, u as resolveHeartbeatSummaryForAgent } from "./health-format-CiFibdOd.js";
import { C as resolveEffectiveUpdateChannel, S as normalizeUpdateChannel, c as formatUpdateOneLiner, d as checkShellCompletionStatus, h as compareSemverStrings, l as getUpdateCheckResult, m as checkUpdateStatus, p as ensureCompletionCacheExists, s as formatUpdateAvailableHint, u as resolveUpdateAvailability, x as formatUpdateChannelLabel } from "./update-runner-BTYt2SFz.js";
import { n as logConfigUpdated } from "./logging-ORrUajqM.js";
import { t as buildWorkspaceHookStatus } from "./hooks-status-BYoQnpZH.js";
...
async function finalizeOnboardingWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-YnwBluzD.js").then((n) => n.r);
