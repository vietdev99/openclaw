...
import { c as writeConfigFile, h as parseDurationMs, i as loadConfig, o as readConfigFileSnapshot, r as createConfigIO } from "./config-lDytXURd.js";
import { n as movePathToTrash } from "./server-context-jZtjtSoj.js";
import { i as randomIdempotencyKey, n as callGateway } from "./call-D0A17Na5.js";
...
import { d as loadSessionStore } from "./sandbox-DIgdWyWl.js";
import { r as runCommandWithRuntime } from "./cli-utils-BpfYfZQ6.js";
import { n as ensurePluginRegistryLoaded, t as hasExplicitOptions } from "./command-options-Dz1YNH1L.js";
import { l as getVerboseFlag, o as getFlagValue, r as registerSubCliCommands, s as getPositiveIntFlagValue, u as hasFlag } from "./register.subclis-clXxr8kI.js";
import { n as parsePositiveIntOrUndefined, t as collectOption } from "./helpers-CUVSCDJV.js";
import { n as callGatewayFromCli, t as addGatewayClientOptions } from "./gateway-rpc-BJUvqjlF.js";
import { t as createDefaultDeps } from "./deps-BKhViD8a.js";
import { a as gatewayInstallErrorHint, h as assertSupportedRuntime, i as buildGatewayInstallPlan, r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-kbHzTKou.js";
...
import { d as applyAuthChoice, f as applyOpenAIConfig, h as promptAuthChoiceGrouped, m as applyGoogleGeminiModelDefault, p as upsertSharedEnvVar, u as warnIfModelConfigLooksOff } from "./onboard-skills-Wyguo5Lc.js";
import { l as healthCommand } from "./health-format-CBx5Mfn3.js";
...
import { a as findAgentEntryIndex, c as pruneAgentConfig, d as parseIdentityMarkdown, f as runOnboardingWizard, i as buildAgentSummaries, l as identityHasValues, o as listAgentEntries, r as applyAgentConfig, s as loadAgentIdentity, t as statusCommand } from "./status-X6ahGX3S.js";
import { a as createOutboundSendDeps, n as resolveSessionKeyForRequest, t as agentCommand } from "./agent-BRekfAhw.js";
import { t as formatHelpExamples } from "./help-format-B6V9MyR5.js";
import { i as CONFIGURE_WIZARD_SECTIONS, n as configureCommand, r as configureCommandWithSections } from "./configure-Dbh6cH0K.js";
import { n as ensureSystemdUserLingerNonInteractive } from "./systemd-linger-DlKqKaRl.js";
import { n as loadAndMaybeMigrateDoctorConfig, t as doctorCommand } from "./doctor-B6OoszOc.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Config helpers (get/set/unset). Run without subcommand for the wizard.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configure wizard sections (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { CONFIGURE_WIZARD_SECTIONS, configureCommand, configureCommandWithSections } = await import("./configure-Dbh6cH0K.js").then((n) => n.t);
