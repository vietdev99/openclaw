import { B as danger, H as logVerbose, l as createSubsystemLogger } from "./exec-B7WKla_0.js";
import { O as isTruthyEnvValue } from "./model-selection-BLfS3yxa.js";
import { D as isGifMedia, j as mediaKindFromMime, w as getFileExtension, z as resolveTelegramAccount } from "./image-ops-CHacgj65.js";
import { t as loadConfig } from "./config-DxG-_fT0.js";
import { n as formatErrorMessage, r as formatUncaughtError, t as extractErrorCode } from "./errors-Bu1M2BY3.js";
import { n as retryAsync, t as resolveRetryConfig } from "./retry-B-r9sEns.js";
import { d as resolveMarkdownTableMode, i as markdownToIR, n as wrapFetchWithAbortSignal, o as loadWebMedia, r as chunkMarkdownIR, t as resolveFetch } from "./fetch-ByF-CNua.js";
...
//#endregion
export { resolveTelegramForumThreadId as A, renderMarkdownWithMarkers as B, buildTelegramThreadParams as C, extractTelegramLocation as D, expandTextLinks as E, toLocationContext as F, parseTelegramTarget as H, withTelegramApiErrorLogging as I, createDiscordRetryRunner as L, resolveTelegramStreamMode as M, resolveTelegramThreadSpec as N, hasBotMention as O, formatLocationText as P, getChannelActivity as R, buildTelegramParentPeer as S, describeReplyTarget as T, isVoiceCompatibleAudio as V, buildGroupLabel as _, sendMessageTelegram as a, buildTelegramGroupFrom as b, resolveTelegramVoiceSend as c, isRecoverableTelegramNetworkError as d, markdownToTelegramChunks as f, splitTelegramCaption as g, resolveTelegramFetch as h, reactMessageTelegram as i, resolveTelegramReplyId as j, normalizeForwardedContext as k, wasSentByBot as l, renderTelegramHtmlText as m, deleteMessageTelegram as n, sendStickerTelegram as o, markdownToTelegramHtml as p, editMessageTelegram as r, send_exports as s, buildInlineKeyboard as t, makeProxyFetch as u, buildSenderLabel as v, buildTypingThreadParams as w, buildTelegramGroupPeerId as x, buildSenderName as y, recordChannelActivity as z };