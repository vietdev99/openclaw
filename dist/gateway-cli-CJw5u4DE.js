import { $ as normalizeOptionalAgentId, $n as resolveTtsAutoMode, $t as registerSkillsChangeListener, An as getAgentRunContext, Ar as DEFAULT_INPUT_IMAGE_MAX_BYTES, B as isGatewaySigusr1RestartExternallyAllowed, Bn as formatUserTime, Bt as primeRemoteSkillsCache, C as readSessionPreviewItemsFromTranscript, Cn as formatZonedTimestamp, Cr as enqueueSystemEvent, D as ensureOutboundSessionEntry, Dr as DEFAULT_INPUT_FILE_MAX_BYTES, En as initSubagentRegistry, Er as loadModelCatalog, Fr as DEFAULT_INPUT_PDF_MIN_TEXT_CHARS, Ft as CONTROL_UI_AVATAR_PREFIX, G as formatRestartSentinelMessage, Gn as registerInternalHook, Gt as approveNodePairing, H as setGatewaySigusr1RestartPolicy, Hn as resolveUserTimezone, Ht as refreshRemoteBinsForConnectedNodes, I as runWithModelFallback, Ir as DEFAULT_INPUT_TIMEOUT_MS, It as buildControlUiAvatarUrl, Jn as OPENAI_TTS_VOICES, Jt as renamePairedNode, Kn as triggerInternalHook, Kt as listNodePairing, Lr as extractFileContentFromSource, Lt as normalizeControlUiBasePath, M as resolveSessionDeliveryTarget, Mn as registerAgentRunContext, Mr as DEFAULT_INPUT_MAX_REDIRECTS, Nr as DEFAULT_INPUT_PDF_MAX_PAGES, O as resolveOutboundSessionRoute, On as clearAgentRunContext, Or as DEFAULT_INPUT_FILE_MAX_CHARS, P as resetDirectoryCache, Pn as normalizePollInput, Pr as DEFAULT_INPUT_PDF_MAX_PIXELS, Q as inferLegacyName, Qn as resolveTtsApiKey, Qt as getSkillsSnapshotVersion, R as authorizeGatewaySigusr1Restart, Rn as resolveAgentIdentity, Rr as extractImageContentFromSource, Rt as resolveAssistantAvatarUrl, S as readSessionMessages, Sn as createReplyDispatcher, Sr as parseVerboseOverride, T as stripEnvelopeFromMessages, Tn as stopSubagentsForRequester, U as consumeRestartSentinel, Un as clearInternalHooks, Ut as refreshRemoteNodeBins, V as scheduleGatewaySigusr1Restart, Vn as resolveUserTimeFormat, Vr as resolveAgentTimeoutMs, Vt as recordRemoteNodeInfo, W as formatDoctorNonInteractiveHint, Wn as createInternalHookEvent, Wt as setSkillsRemoteRegistry, X as normalizeCronJobCreate, Xn as isTtsEnabled, Xt as updatePairedNodeMetadata, Y as writeRestartSentinel, Yn as getTtsProvider, Yt as requestNodePairing, Z as normalizeCronJobPatch, Zn as isTtsProviderConfigured, Zt as verifyNodeToken, _ as loadSessionEntry, _r as stripHeartbeatToken, a as normalizeSendPolicy, ar as textToSpeech, b as archiveFileOnDisk, br as applyModelOverrideToSessionEntry, c as runEmbeddedPiAgent, cn as normalizeGroupActivation, cr as setCommandLaneConcurrency, ct as getPluginToolMeta, dr as stopDiagnosticHeartbeat, en as buildSafeExternalPrompt, er as resolveTtsConfig, et as normalizeOptionalText, f as createOpenClawTools, fn as buildHistoryContextFromEntries, fr as isDiagnosticsEnabled, g as loadCombinedSessionStoreForGateway, gn as onHeartbeatEvent, h as listSessionsFromStore, hn as getLastHeartbeatEvent, ht as handleSlackHttpRequest, i as runCliAgent, ir as setTtsProvider, j as resolveOutboundTarget, jn as onAgentEvent, jr as DEFAULT_INPUT_IMAGE_MIMES, kn as emitAgentEvent, kr as DEFAULT_INPUT_FILE_MIMES, l as abortEmbeddedPiRun, lr as CommandLane, lt as loadOpenClawPlugins, m as listAgentsForGateway, n as getCliSessionId, nn as getHookType, nr as resolveTtsProviderOrder, nt as normalizeRequiredName, o as resolveSendPolicy, or as clearAllCommandLanes, ot as requestHeartbeatNow, p as resolveAnnounceTargetFromKey, pn as resolveHeartbeatVisibility, pr as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, q as summarizeRestartSentinel, qn as OPENAI_TTS_MODELS, qt as rejectNodePairing, r as setCliSessionId, rn as isExternalHookSession, rr as setTtsEnabled, rt as migrateLegacyCronPayload, s as clearSessionQueues, sn as createReplyPrefixOptions, tn as detectSuspiciousPatterns, tr as resolveTtsPrefsPath, tt as normalizePayloadToSystemText, u as waitForEmbeddedPiRunEnd, un as registerUnhandledRejectionHandler, ur as startDiagnosticHeartbeat, ut as loadProviderUsageSummary, v as resolveGatewaySessionStoreTarget, vr as lookupContextTokens, w as resolveSessionTranscriptCandidates, wn as isAbortTrigger, wr as isSystemEventContextChanged, wt as handleReset, x as capArrayByJsonBytes, xn as dispatchInboundMessage, xr as applyVerboseOverride, y as resolveSessionModelRef, z as consumeGatewaySigusr1RestartAuthorization, zr as normalizeMimeList, zt as getRemoteSkillEligibility } from "./reply-CB1HncR0.js";
import { B as normalizeElevatedLevel, H as normalizeThinkLevel, I as formatThinkingLevels, K as supportsXHighThinking, L as formatXHighModelHint, U as normalizeUsageDisplay, V as normalizeReasoningLevel, W as normalizeVerboseLevel } from "./pi-embedded-helpers-2_03xTck.js";
...
import { d as inspectPortUsage, l as ensurePortAvailable, p as formatPortDiagnostics } from "./chrome-C-btz7RP.js";
import { d as hasBinary, i as loadWorkspaceSkillEntries, r as buildWorkspaceSkillSnapshot } from "./skills-DvalK49l.js";
import { r as saveMediaBuffer } from "./routes-BZ6CZRJO.js";
...
import { n as createOutboundSendDeps, t as createDefaultDeps } from "./deps-Dp0SSnb7.js";
import { i as enableTailscaleServe, n as disableTailscaleServe, o as getTailnetHostname, r as enableTailscaleFunnel, t as disableTailscaleFunnel } from "./tailscale-Dmbkh3Jx.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-D5tY1EW-.js";
import "./daemon-runtime-wpwJ6TMm.js";
import { c as loadAgentIdentity, d as loadAgentIdentityFromWorkspace, p as forceFreePortAndWait, r as getStatusSummary, t as runOnboardingWizard } from "./onboarding-B-J7Nbai.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-CzxFFxrk.js";
import "./logging-BEb-f2x1.js";
import "./note-tuVVUKwG.js";
import { t as WizardCancelledError } from "./prompts-BOz5176z.js";
import { i as discoverGatewayBeacons, n as installSkill } from "./onboard-skills-B8XIu18e.js";
import { v as applyAuthProfileConfig } from "./github-copilot-auth-Clo2McQt.js";
import "./onboard-channels-Dey_diQI.js";
import { r as buildChannelUiCatalog, t as applyPluginAutoEnable } from "./plugin-auto-enable-Run4xh84.js";
import "./archive-DqNr5i8b.js";
import "./skill-scanner-SiymKr6J.js";
import "./installs-DpvkI0Vf.js";
import { a as resolveControlUiRootOverrideSync, c as getHealthSnapshot, d as runHeartbeatOnce, f as setHeartbeatsEnabled, n as ensureControlUiAssetsBuilt, o as resolveControlUiRootSync, p as startHeartbeatRunner, s as formatHealthChannelLines } from "./health-format-DJrrrP5C.js";
import { S as normalizeUpdateChannel, _ as resolveNpmChannelTag, h as compareSemverStrings, m as checkUpdateStatus, t as runGatewayUpdate, y as DEFAULT_PACKAGE_CHANNEL } from "./update-runner-CkODAlIi.js";
import { a as resolveGatewayBindHost, n as isLoopbackHost$2, o as resolveGatewayClientIp, r as isTrustedProxyAddress, s as resolveGatewayListenHosts, t as isLoopbackAddress } from "./net-BSOsAxNU.js";
import { i as resolveGatewayAuth, n as authorizeGatewayConnect, r as isLocalDirectRequest, t as assertGatewayAuthConfigured } from "./auth-DsiI1FA8.js";
import { i as probeGateway } from "./audit-BbwcHQGY.js";
import "./table-CUojT09_.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-C3tW33Fh.js";
import "./service-DCJ10BWe.js";
import "./systemd-B4GAf9ji.js";
import "./service-audit-Da6maOeP.js";
import "./node-service-CtYURYEg.js";
import "./channels-status-issues-C5az9k-w.js";
import "./completion-cli-D5WMLiYK.js";
import { a as createOutboundSendDeps$1, i as resolveAgentOutboundTarget, r as resolveAgentDeliveryPlan, t as agentCommand } from "./agent-kopsISie.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-wo6a1bmI.js";
import { i as shouldIncludeHook, n as loadWorkspaceHookEntries, r as resolveHookConfig } from "./hooks-status-CBwtt470.js";
import "./tui-Dbd1saQd.js";
import { t as buildChannelAccountSnapshot } from "./status-C_dMhoE0.js";
import "./shared-DGpBKj0v.js";
import { a as runDaemonStop, i as runDaemonStart, n as runDaemonStatus, o as runDaemonUninstall, r as runDaemonRestart, s as runDaemonInstall } from "./daemon-cli-DCLLyfW_.js";
import { a as toOptionString, i as parsePort$1, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-DeuYLQpd.js";
import { i as setGatewayWsLogStyle, n as logWs, r as summarizeAgentEventForWsLog, t as formatForLog } from "./ws-log-BJ0jiKEa.js";
import { T as resolveGmailHookRuntimeConfig, _ as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, v as buildGogWatchStartArgs } from "./gmail-setup-utils-B6H4iU5L.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-nPkT0dp4.js");
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		const { loadSessionLogs } = await import("./session-cost-usage-Cgjv1tAn.js").then((n) => n.a);
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./control-service-DccSOCD2.js").then((n) => n.t);
